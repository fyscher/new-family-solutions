...
const values = [
  ...
  },
  {
    ...
    body: "We follow FSCD best-practice standards, because your family deserves nothing less than the highest quality of care.",
  },
];
  ...
  return (
    <div className="about-us-page">
      ...
      >
        ...
        >
          {values.map((v) => (
            <motion.div key={v.heading} className="value-card" variants={itemVariants}>
              <h3>{v.heading}</h3>
              <p>{v.body}</p>
            </motion.div>
          ))}
